...
% Custom colors (defined BEFORE use)
...
\begin{document}
	...
	\begin{quote}
		\emph{This is a bridge role intended to support you until you secure a permanent position. 	
			The training path is structured and intensive. Realistically, it takes 6 months to 2 years to gain full readiness for the role, depending on consistency and depth of practice.}
	...
	\textbf{Important Clarification — Role Reality:}
	
	This is \textbf{not a coding-intensive role}. You will \textbf{not} be writing production software, building algorithms, or developing applications from scratch. Instead, your daily work will focus on:
	
	\begin{itemize}
		\item \textbf{Wiki page creation \& maintenance} — Documenting processes, infrastructure layouts, simulation workflows, and troubleshooting guides in a structured, shareable format
		\item \textbf{Note-making \& organization} — Converting technical discussions, video walkthroughs, and ticket resolutions into clear, searchable documentation
		\item \textbf{YouTube video curation \& arrangement} — Organizing existing video content into logical playlists; annotating key timestamps; creating viewing guides for team members
		\item \textbf{Data \& workflow analysis} — Observing how big-data systems behave; documenting patterns, anomalies, and improvement opportunities; presenting findings as an analyst would
		\item \textbf{Administrative support for data infrastructure} — Tracking tickets, organizing training materials, maintaining runbooks, and ensuring the team's knowledge base stays up to date
	\end{itemize}
	
	You will be shown how to \textbf{think and observe like an analyst} — identifying what matters, documenting it clearly, and helping others navigate complex systems without writing code. The Udemy courses listed below are for \textbf{context and vocabulary} — so you understand what engineers are discussing — not for becoming a developer.
	
	\textbf{Success in this role means:}
	\begin{itemize}
		\item You can read and summarize technical content accurately
		\item You can organize information into logical wiki pages
		\item You can watch a technical YouTube video and extract the 5 key points for the team
		\item You can track a ticket, note what happened, and document the resolution steps
		\item You rarely (if ever) write code — but you understand enough to support those who do
	\end{itemize}
	
	\textit{This is an admin-support and analyst-observation role. The training emphasizes comprehension, documentation, and organization — not programming.}
...
\begin{tabularx}{\textwidth}{|X|p{3cm}|p{3cm}|X|}
	...
	\hline
	3.5 & \href{https://www.udemy.com/course/big-data-code-changes-for-full-stack-simulation-engine-2026/}{Course 3.5: Big Data Code Changes for Full‑Stack Simulation Engine 2026} & 2–3 days & Bridge infrastructure \& Python; understand code change patterns for simulation engines; prepare for distributed analytics \\
	\hline
\end{tabularx}
	...
	\vspace{1cm}
	\noindent\textit{Document generated from the original training plan by Shivgan Joshi. All Udemy links are preserved as provided.}
