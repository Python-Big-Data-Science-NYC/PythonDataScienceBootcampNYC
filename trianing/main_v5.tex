...
\begin{document}
	...
	\begin{quote}
		...
		The courses must be taken in the order listed below, as each builds on the previous one. Training will focus heavily on \textbf{Python}, \textbf{py spark code edits in distributed systems}, \textbf{testing and re-running pyspark code}, and \textbf{understanding HIVE Joins in big-data setup}.
	...
	\begin{itemize}
		...
		\item Initial readiness: approximately 8-12 weeks (all 13-15 courses)
