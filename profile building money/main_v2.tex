...
\subtitle{High-Volume Research Strategy: 20-50 Papers  1000-2000 Citations 2 years}
...
\begin{document}
	...
	\begin{frame}{Budget Breakdown - Publishing 25 Papers}
		...
		\begin{block}{Cost Per Paper Strategy}
			...
			\begin{tabular}{|p{4cm}|p{3cm}|p{3cm}|}
				...
				Preprints & All & \$0 \\
				\hline
				\textbf{Total} & \textbf{25+} & \textbf{\$6,000-\$11,000} \\
				\hline
			\end{tabular}
		\end{block}
	...
	\begin{frame}{50 Papers - The High-Volume Strategy}
		...
		\begin{block}{Why Volume Matters}
			\begin{itemize}
				...
				\item Manual submission to top indexing like MPRO, ERIC, OSF, Sciexplorer
			\end{itemize}
		\end{block}
		\begin{block}{How to Achieve 50 Papers in 2-3 Years}
			\begin{itemize}
				...
				\item \textbf{Extend conference papers:} Conference → extended version → journal
	...
	\begin{frame}{Year 3 - Papers 36-50}
		...
		\begin{block}{Government Citations}
			\begin{itemize}
				...
				\item Portfolio complete and ready
			\end{itemize}
		\end{block}
	\end{frame}
	...
	\begin{frame}{Book Chapters - Adding 5-10 Chapters}
		...
		\begin{block}{How to Get Book Chapter Invitations}
			\begin{itemize}
				...
				\item They email: "Would you like to contribute a chapter on topic"
	...
	% ============================================================
	\begin{frame}{LinkedIn - Free Research Promotion}
		\scriptsize
		\begin{block}{LinkedIn Strategy for Citations}
			...
			\end{itemize}
		\end{block}
		\begin{block}{Sample LinkedIn Post}
			\begin{verbatim}
				Our new paper on "Machine Learning for Financial 
				Stability" is now available on arXiv. 
				We analyze methods for detecting banking system 
		...
		\begin{block}{Results from Consistent LinkedIn Posting}
			\begin{itemize}
				\item 10x more downloads when shared on LinkedIn
	...
	% ============================================================
	% SLIDE 41: CHATGPT/DEEPSEEK FOR DRAFTING - ACCELERATE WRITING
	% ============================================================
	...
	% ============================================================
	% SLIDE 47: COMMON MISTAKES - VOLUME EDITION
	% ============================================================
