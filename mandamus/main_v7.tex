...
\end{frame}
	...
	% ============================================================
	% STRATEGIC SLIDE 1 OF 3: THE KATIGBAK LOOPHOLE
	% ============================================================
	
	\begin{frame}{Strategic Impact: The Katigbak Loophole}
		\setbeamerfont{itemize/enumerate body}{size=\tiny}
		\setbeamerfont{block body}{size=\tiny}
		\scriptsize
		\begin{block}{Adding Impact, Not Achievements}
			\textbf{The Problem:} \textit{Matter of Katigbak} bars evidence of achievements (new papers, new awards) created \textbf{after} the filing date.
			\vspace{0.1cm}
			\textbf{The Solution:} Prove that work performed \textbf{before} the priority date is gaining \textbf{new recognition}. You are not showing "new work"; you are showing the "ongoing national importance" of the \textbf{original work}.
		\end{block}
	\end{frame}
	
	
	% ============================================================
	% STRATEGIC SLIDE 2 OF 3: NEW INDEXING OF PRE-FILING RESEARCH
	% ============================================================
	
	\begin{frame}{New Indexing of Pre-Filing Research}
		\setbeamerfont{itemize/enumerate body}{size=\tiny}
		\setbeamerfont{block body}{size=\tiny}
		\scriptsize
		\begin{block}{How Old Work Gains New Recognition}
			If an old paper (published before filing) is newly indexed in major repositories, it constitutes a "new material fact" regarding the work's reach:
			\vspace{0.1cm}
			\textbf{Academic Databases:}
			\begin{itemize}
				\item ERIC (U.S. Dept of Education)
				\item SSRN (Elsevier)
				\item MPRA (Munich Personal RePEc Archive)
				\item EconPapers (RePEc)
			\end{itemize}
			\textbf{Institutional Repositories:}
			\begin{itemize}
				\item Harrisburg University Research
				\item SciExplorer
	...
	% ============================================================
	% STRATEGIC SLIDE 3 OF 3: RETROSPECTIVE AWARDS & REGULATORY IMPACT
	% ============================================================
	
	\begin{frame}{Retrospective Awards \& Regulatory Impact}
		\setbeamerfont{itemize/enumerate body}{size=\tiny}
		\setbeamerfont{block body}{size=\tiny}
		\scriptsize
		\begin{block}{Work-Based Awards}
			International awards like the \textbf{Globee, Stevie, or Titan Business Awards} won post-filing for projects/papers completed \textbf{pre-filing}. Argue that the award validates the importance \textit{as it stood} at the time of filing.
		\end{block}
		
		\begin{block}{Regulatory Influence}
			If your pre-filing comments on \textbf{Regulations.gov} are cited in a Paperwork Reduction Act (PRA) or Information Collection Request (ICR) notice, this is objective evidence of impact on U.S. government policy.
		\end{block}
		
		\begin{block}{Strategic Takeaway}
			\textcolor{blue}{Focus the MTR on the \textbf{discovery} of this recognition, not the creation of the work itself.}
		\end{block}
	\end{frame}
